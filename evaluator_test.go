...
//	jsonRaw := `{"color":"red", "temperature":50,"metadata": {"name": "Light1", "price": 11.05},"params": {"OPCUA#Lu1_Bottom_Waice_Temp": {"value":123}}}`
...
//		want interface{}
//	}{
//		{"sql", ctx, `select color from a/b`, JSONNode(`{"color":"red"}`)},
...
//}
//
//func TestSQLDimensions(t *testing.T) {
//	jsonRaw := `{"color":"red", "temperature":50,"metadata": {"name": "Light1", "price": 11.05}}`
//	ctx := NewJSONContext(jsonRaw)
//	tests := []struct {
//		name string
//		ctx  Context
...
//					temperature - '1' AS temp
//                  from a/b
//			      GROUP BY temperature, TUMBLINGWINDOW(ss, 10)`,
//			StringNode(`50`)},
//		{"sql", ctx,
//			`select
//					avg(temperature) - '1' AS temp,
//					*
//                  from a/b
//			      GROUP BY metadata.name, TUMBLINGWINDOW(ss, 10)`,
//			StringNode(`Light1`)},
//	}
//	Convey("run test", t, func() {
//		for _, tt := range tests {
//			expr, _ := Parse(tt.expr) // Filter expr
//			Dump(expr)
//			So(EvalDimensions(tt.ctx, expr), ShouldEqual, tt.want)
//		}
//	})
//}
//
...
//		want interface{}
//	}{
//		{"function", DefaultValue, `abs(1) + 1`, IntNode(2)},
//		{"function", DefaultValue, `abs(-1) + 1`, IntNode(2)},
//		{"function", DefaultValue, `abs(1.0) + 1`, FloatNode(2.0)},
//		{"function", DefaultValue, `abs(-1.0) + 1`, FloatNode(2.0)},
//	}
//	Convey("run test", t, func() {
//		for _, tt := range tests {
//			expr, _ := ParseExpr(tt.expr) // Filter expr
//			So(EvalRuleQL(tt.ctx, expr), ShouldEqual, tt.want)
//		}
//	})
//}
